            ...
            <form>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="tel" class="w-full p-2 border border-gray-500 text-gray-800 rounded mb-4" required>
                    ...
                    <div>
                        ...
                        <input type="email" class="w-full p-2 border border-gray-500 text-gray-800 rounded mb-4" required>
